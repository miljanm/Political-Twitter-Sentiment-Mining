...
if __name__ == '__main__':
    ...
    parameter_space = product(stemmings, TFIDFs, stop_wordss, max_featuress, ngram_ranges)
    
    for stemming, TFIDF, stop_words, max_features, ngram_range in parameter_space:
